...
export const metadata: Metadata = {
  ...
  authors: [{ name: "Aditya Ranjan", url: "https://iamadityaranjan.com" }],
  creator: "Aditya Ranjan",
  metadataBase: new URL("https://videosummary.iamadityaranjan.com"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
    ...
    type: "website",
    siteName: "AI Video Summarizer",
    url: "https://videosummary.iamadityaranjan.com",
    locale: "en_US",
  },
  twitter: {
    card: "summary_large_image",
